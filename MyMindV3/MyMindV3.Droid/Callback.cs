...
{
    public class ChatCallback : Java.Lang.Object, ICallbacks
    {
        ...
        public ChatCallback(Action<Org.Json.JSONObject> onSuccess, Action<Org.Json.JSONObject> onFail, Action<Org.Json.JSONObject> onUserInfoCallback
