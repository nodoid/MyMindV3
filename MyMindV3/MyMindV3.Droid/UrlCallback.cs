...
{
    public class UrlCallback : Java.Lang.Object, ICallbacks
    {
        ...
        public UrlCallback(Action<Org.Json.JSONObject> onSuccess, Action<Org.Json.JSONObject> onFail, Action<Org.Json.JSONObject> onUserInfoCallback
