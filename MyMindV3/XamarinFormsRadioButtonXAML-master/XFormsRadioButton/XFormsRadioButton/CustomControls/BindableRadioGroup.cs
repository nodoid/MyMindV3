...
namespace XFormsRadioButton.CustomControls
{
    public class BindableRadioGroup : StackLayout
    {
        ...
        public static BindableProperty ItemsSourceProperty = BindableProperty.Create(nameof(ItemsSource), typeof(IEnumerable), typeof(BindableRadioGroup), null);

        public static BindableProperty SelectedIndexProperty = BindableProperty.Create(nameof(SelectedIndex), typeof(int), typeof(BindableRadioGroup), -1);
